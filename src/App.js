...
function App(props) {
  ...
  useEffect(() => {
    axios
      .get(`https://www.kayak.com/h/mobileapis/directory/airlines/homework`)
      .then(res => {
        const dataItems = res.data;
        const header_refactor = dataItems.replace('/**/invalidCallbackFunctionName(','');
            ...
            <div className='tile__filter'>
              ...
              <div className='tile__filter__group'>
                <div className='tile__filter__group-item'>
                  <label className="checkbox" onChange={event => {setAlliance(event.target.value)}}>Oneworld
                    <input value="OW" name="tile__filter" type="radio"/>
                    <span className="checkmark"></span>
                  </label>
                </div>
                <div className='tile__filter__group-item'>
                  <label className="checkbox" onChange={event => {setAlliance(event.target.value)}}>Sky Team
                    <input value="ST" name="tile__filter" type="radio"/>
                    <span className="checkmark"></span>
                  </label>
                </div>
                <div className='tile__filter__group-item'>
                  <label className="checkbox" onChange={event => {setAlliance(event.target.value)}}>Star Alliance
